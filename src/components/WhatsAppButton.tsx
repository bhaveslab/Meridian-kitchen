...
// Deliberately branded in WhatsApp's own green, not the app's gold/dark
// palette — the whole point is that guests recognize it as WhatsApp at a
// glance, not that it blends in.
export default function WhatsAppButton({ phone }: { phone: string | null | undefined }) {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="st-whatsapp-bar">
      <span className="st-whatsapp-badge">
        <WhatsAppGlyph />
      </span>
      {t("whatsappCta")}
    </a>
