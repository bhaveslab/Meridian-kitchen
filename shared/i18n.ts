...
export const UI_STRINGS = {
  ...
  stepReceived: { en: "Received", es: "Recibido" },
  stepPreparing: { en: "Preparing", es: "Preparando" },
  stepReady: { en: "Ready", es: "Listo" },
  stepOutForDelivery: { en: "Out for delivery", es: "En camino" },
  stepCompleted: { en: "Completed", es: "Completado" },
  dashboardOrders: { en: "Orders", es: "Pedidos" },
  dashboardMenu: { en: "Menu", es: "Menú" },
  viewStorefront: { en: "View storefront", es: "Ver tienda" },
  dashboardLoginTitle: { en: "Staff login", es: "Acceso del personal" },
  ...
  whatsappCta: { en: "Order by phone", es: "Pedir por teléfono" },
